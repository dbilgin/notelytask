  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        ...
        <p>This privacy policy applies to the NotelyTask app (hereby referred to as "Application") for mobile devices that was
          created by <a href="https://github.com/dbilgin/" target="_blank">dbilgin</a> (hereby referred to as "Service
        ...
        <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
          ...
          contact them at omedacore@gmail.com and they will respond in a reasonable time.</p><br><strong>Children</strong>
        ...
        <div><br>
          <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect
            ...
            information, please contact the Service Provider (omedacore@gmail.com) so that they will be able to take the
            necessary actions.</p>
        ...
        <p>This privacy policy is effective as of 2024-04-01</p><br><strong>Your Consent</strong>
        ...
        <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
          please contact the Service Provider via email at omedacore@gmail.com.</p>
              </body>
